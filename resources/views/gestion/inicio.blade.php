...
<div class="mod-section">
    ...
    <div class="mod-grid">
        ...
        <a href="{{ route('users.index') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Usuarios</h2><p>Gestión de usuarios del sistema</p></div>
        ...
        <a href="{{ route('clientes.index') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Clientes</h2><p>Base de datos de clientes</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
        @endcan
        <a href="{{ route('vacaciones.index') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Vacaciones</h2><p>Solicitud y calendario de vacaciones</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
    </div>
</div>
...
<div class="mod-section">
    ...
    <div class="mod-grid">
        ...
        <a href="{{ route('roles.index') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Roles</h2><p>Gestión de roles del sistema</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
        @endcan
        @can('ver roles')
        <a href="{{ route('gestion.permisos') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Permisos</h2><p>Matriz de permisos por rol</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
        @endcan
        ...
        <a href="{{ route('restricciones.index') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Restricciones</h2><p>Restricciones de acceso por entidad</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
        @endcan
        <a href="{{ route('gestion.politica') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Política</h2><p>Política de seguridad del sistema</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
        @role('Super Admin')
        <a href="{{ route('logs.index') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Logs del sistema</h2><p>Monitor de errores y eventos de seguridad</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
        @endrole
    </div>
...
<div class="mod-section">
    ...
    <div class="mod-grid">
        ...
        <a href="{{ route('noticias.index') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Noticias</h2><p>Noticias y comunicados internos</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
        @endcan
        @can('ver campanias')
        <a href="{{ route('campanias.index') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Campañas</h2><p>Gestión de campañas publicitarias</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
        @endcan
    </div>
...
<div class="mod-section">
    ...
    <div class="mod-grid">
        ...
        <a href="{{ route('empresas.index') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Empresas</h2><p>Empresas del grupo</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
        @endcan
        ...
        <a href="{{ route('departamentos.index') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Departamentos</h2><p>Departamentos de la organización</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
        @endcan
        @can('ver centros')
        <a href="{{ route('centros.index') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Centros</h2><p>Centros de trabajo y ubicaciones</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
        @endcan
        <a href="{{ route('gestion.marcas') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Marcas</h2><p>Marcas de vehículos gestionadas</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
        @can('ver naming-pcs')
        <a href="{{ route('naming-pcs.index') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Naming PCs</h2><p>Nomenclatura de equipos informáticos</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
        @endcan
        @can('ver festivos')
        <a href="{{ route('festivos.index') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Festivos</h2><p>Calendario de festivos por municipio</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
        @endcan
        ...
        <a href="{{ route('incidencias.index') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Incidencias</h2><p>Gestión de incidencias y soporte</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
        @endcan
        @endif
...
<div class="mod-section">
    ...
    <div class="mod-grid">
        <a href="{{ route('dataxis.inicio') }}" class="mod-card">
            ...
            <div class="mod-card-info"><h2>Dataxis</h2><p>Análisis, estadísticas y gráficas de datos</p></div>
            <i class="bi bi-arrow-right mod-card-arrow"></i>
        </a>
    </div>
</div>
