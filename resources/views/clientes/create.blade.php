@extends('layouts.app')
@section('title', 'Crear Cliente - VEXIS')
@section('content')
<div class="vx-page-header">
    <h1 class="vx-page-title">Crear Nuevo Cliente</h1>
        ...
        <form action="{{ route('clientes.store') }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 16px;">
                <div class="vx-form-group">
                    ...
                    <input type="text" class="vx-input @error('dni') is-invalid @enderror" id="dni" name="dni" value="{{ old('dni') }}" maxlength="10" placeholder="12345678A">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 16px;">
                <div class="vx-form-group">
                    ...
                    <input type="email" class="vx-input @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="cliente@ejemplo.com" required>
                ...
                <div class="vx-form-group">
                    ...
                    <input type="text" class="vx-input @error('telefono') is-invalid @enderror" id="telefono" name="telefono" value="{{ old('telefono') }}" placeholder="928123456" maxlength="20" required>
            ...
            <div class="vx-form-group">
                ...
                <input type="text" class="vx-input @error('domicilio') is-invalid @enderror" id="domicilio" name="domicilio" value="{{ old('domicilio') }}" placeholder="Calle, número, piso..." required>
            ...
            <div class="vx-form-group">
                ...
                <input type="text" class="vx-input @error('codigo_postal') is-invalid @enderror" id="codigo_postal" name="codigo_postal" value="{{ old('codigo_postal') }}" maxlength="5" placeholder="35001" required style="max-width: 150px;">
