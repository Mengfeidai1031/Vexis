...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;max-width:950px;">
    <div class="vx-card"><div class="vx-card-header"><h2>Datos de la Venta</h2></div><div class="vx-card-body">
    ...
    <div class="vx-card"><div class="vx-card-header"><h2>Vehículo y Cliente</h2></div><div class="vx-card-body">
