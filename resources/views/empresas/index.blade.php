...
<x-filtros-avanzados :action="route('empresas.index')">
    ...
    <div class="vx-filtro" data-filtro="domicilio"><label class="vx-filtro-label">Domicilio</label><select name="domicilio" class="vx-select"><option value="">Todos</option>@foreach($empresas as $e)@if($e->domicilio)<option value="{{ $e->domicilio }}" {{ request('domicilio') == $e->domicilio ? 'selected' : '' }}>{{ $e->domicilio }}</option>@endif @endforeach</select></div>
    ...
    <div class="vx-filtro" data-filtro="telefono"><label class="vx-filtro-label">Teléfono</label><select name="telefono" class="vx-select"><option value="">Todos</option>@foreach($empresas as $e)@if($e->telefono)<option value="{{ $e->telefono }}" {{ request('telefono') == $e->telefono ? 'selected' : '' }}>{{ $e->telefono }}</option>@endif @endforeach</select></div>
</x-filtros-avanzados>
<div class="vx-card">
