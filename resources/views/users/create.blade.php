                                    ...
                                    <div class="row">
                                        @foreach($availableRestrictions['empresas'] as $empresa)
                                            <div class="col-md-6 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input restriction-checkbox type-empresas" type="checkbox" name="restrictions[empresas][]" value="{{ $empresa->id }}" id="empresa-{{ $empresa->id }}" {{ in_array($empresa->id, old('restrictions.empresas', [])) ? 'checked' : '' }}>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        @foreach($availableRestrictions['clientes'] as $cliente)
                                            <div class="col-md-6 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input restriction-checkbox type-clientes" type="checkbox" name="restrictions[clientes][]" value="{{ $cliente->id }}" id="cliente-{{ $cliente->id }}" {{ in_array($cliente->id, old('restrictions.clientes', [])) ? 'checked' : '' }}>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        @foreach($availableRestrictions['vehiculos'] as $vehiculo)
                                            <div class="col-md-6 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input restriction-checkbox type-vehiculos" type="checkbox" name="restrictions[vehiculos][]" value="{{ $vehiculo->id }}" id="vehiculo-{{ $vehiculo->id }}" {{ in_array($vehiculo->id, old('restrictions.vehiculos', [])) ? 'checked' : '' }}>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        @foreach($availableRestrictions['centros'] as $centro)
                                            <div class="col-md-6 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input restriction-checkbox type-centros" type="checkbox" name="restrictions[centros][]" value="{{ $centro->id }}" id="centro-{{ $centro->id }}" {{ in_array($centro->id, old('restrictions.centros', [])) ? 'checked' : '' }}>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        @foreach($availableRestrictions['departamentos'] as $departamento)
                                            <div class="col-md-6 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input restriction-checkbox type-departamentos" type="checkbox" name="restrictions[departamentos][]" value="{{ $departamento->id }}" id="departamento-{{ $departamento->id }}" {{ in_array($departamento->id, old('restrictions.departamentos', [])) ? 'checked' : '' }}>
