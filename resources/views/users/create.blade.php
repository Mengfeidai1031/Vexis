...
@section('title', 'Crear Usuario - VEXIS')

@section('content')
<div class="vx-page-header">
    <h1 class="vx-page-title">Crear Nuevo Usuario</h1>
            ...
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 16px;">
                    <div class="vx-form-group">
                        ...
                        <input type="text" class="vx-input @error('telefono') is-invalid @enderror" id="telefono" name="telefono" value="{{ old('telefono') }}" maxlength="12">
                        @error('telefono')<div class="vx-invalid-feedback">{{ $message }}</div>@enderror
                    </div>

                    <div class="vx-form-group">
                        <label class="vx-label" for="extension">Extensión</label>
                        <input type="text" class="vx-input @error('extension') is-invalid @enderror" id="extension" name="extension" value="{{ old('extension') }}" maxlength="10">
                ...
                <div style="display: flex; justify-content: flex-end; gap: 8px; margin-top: 8px;">
                    ...
                    <button type="submit" class="vx-btn vx-btn-primary"><i class="bi bi-check-lg"></i> Guardar Usuario</button>
                </div>
            </form>
        </div>
    </div>
