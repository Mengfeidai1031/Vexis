...
@section('content')
<div class="vx-page-header"><h1 class="vx-page-title">Nuestros Talleres</h1><div class="vx-page-actions"><a href="{{ route('cliente.inicio') }}" class="vx-btn vx-btn-secondary"><i class="bi bi-arrow-left"></i> Volver</a></div></div>

@push('styles')
<style>
.cli-taller-card{transition:all 0.25s cubic-bezier(0.4,0,0.2,1);border-left:3px solid transparent;}
.cli-taller-card:hover{transform:translateY(-3px);box-shadow:0 8px 24px rgba(0,0,0,0.1);border-left-color:#e67e22;}
</style>
@endpush
...
<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(320px,1fr));gap:16px;">
    ...
    <div class="vx-card cli-taller-card">
