...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;max-width:950px;">
    <div class="vx-card"><div class="vx-card-header"><h2>Información</h2></div><div class="vx-card-body">
    ...
    <div>
        <div class="vx-card" style="margin-bottom:16px;"><div class="vx-card-header"><h2>Estadísticas</h2></div><div class="vx-card-body" style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
        ...
        <div class="vx-card"><div class="vx-card-header"><h2>Mecánicos</h2></div><div class="vx-card-body" style="padding:0;">
