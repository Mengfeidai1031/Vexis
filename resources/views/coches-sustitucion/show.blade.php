...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;max-width:950px;">
    ...
    <div>
        {{-- Crear reserva --}}
        <div class="vx-card" style="margin-bottom:16px;"><div class="vx-card-header"><h2>Nueva Reserva</h2></div><div class="vx-card-body">
        ...
        <div class="vx-card"><div class="vx-card-header"><h2>Historial ({{ $coches_sustitucion->reservas->count() }})</h2></div><div class="vx-card-body" style="padding:0;">
