@extends('layouts.app')
@section('title', 'Editar ' . $centro->nombre . ' - VEXIS')
@section('content')
<div class="vx-page-header">
    <h1 class="vx-page-title">Editar: {{ $centro->nombre }}</h1>
        ...
        <div class="vx-card-body">
            <form action="{{ route('centros.update', $centro->id) }}" method="POST">
                ...
                <div class="vx-form-group">
                    ...
                    <input type="text" class="vx-input @error('nombre') is-invalid @enderror" id="nombre" name="nombre" value="{{ old('nombre', $centro->nombre) }}" required>
                ...
                <div class="vx-form-group">
                    ...
                    <select class="vx-select @error('empresa_id') is-invalid @enderror" id="empresa_id" name="empresa_id" required>
                        ...
                        @foreach($empresas as $empresa)
                            <option value="{{ $empresa->id }}" {{ old('empresa_id', $centro->empresa_id) == $empresa->id ? 'selected' : '' }}>{{ $empresa->nombre }}</option>
                        @endforeach
                    </select>
                ...
                <div class="vx-form-group">
                    ...
                    <input type="text" class="vx-input @error('direccion') is-invalid @enderror" id="direccion" name="direccion" value="{{ old('direccion', $centro->direccion) }}" required>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 16px;">
                    <div class="vx-form-group">
                        ...
                        <input type="text" class="vx-input @error('provincia') is-invalid @enderror" id="provincia" name="provincia" value="{{ old('provincia', $centro->provincia) }}" required>
                    ...
                    <div class="vx-form-group">
                        ...
                        <input type="text" class="vx-input @error('municipio') is-invalid @enderror" id="municipio" name="municipio" value="{{ old('municipio', $centro->municipio) }}" required>
